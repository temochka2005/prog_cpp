...
const int crystal_size = 10;
const int disloc_count_max = crystal_size * crystal_size;
...
int main()
{
    ...
    while (disloc_count > 0)
    {
        ...
        f<< static_cast<float>(disloc_count)/ static_cast<float>(crystal_size*crystal_size)  <<  " " <<  counter / 100  << std::endl;
